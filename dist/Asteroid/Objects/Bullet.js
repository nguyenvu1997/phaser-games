export class Bullet extends Phaser.GameObjects.Graphics {
    constructor(aParams) {
        ...
        this.velocity = new Phaser.Math.Vector2(15 * Math.cos(aParams.rotation - Math.PI / 2), 15 * Math.sin(aParams.rotation - Math.PI / 2));
    ...
    checkIfOffScreen() {
        if (this.x > this.scene.sys.canvas.width + 1 ||
